...
import NewPaymentModalDesktop from "./new-payment-modal-desktop"
...
export default function NewPaymentModal() {
  ...
  return (
    <>
      ...
      {isMobile ? (
        <NewPaymentModalMobile open={open} onOpenChange={setOpen} />
      ) : (
        <NewPaymentModalDesktop open={open} onOpenChange={setOpen} />
      )}
    </>
  )
}
